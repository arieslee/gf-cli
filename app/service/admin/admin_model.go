...
// arModel is a active record design model for table bingo_admin operations.
type arModel struct {
	Model *gdb.Model
}

var (
	// Table is the table name of bingo_admin.
	Table = "bingo_admin"
	// Model is the model object of bingo_admin.
