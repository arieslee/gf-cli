...
// arModel is a active record design model for table bingo_category operations.
type arModel struct {
	Model *gdb.Model
}

var (
	// Table is the table name of bingo_category.
	Table = "bingo_category"
	// Model is the model object of bingo_category.
