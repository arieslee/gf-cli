...
// arModel is a active record design model for table bingo_tag_relation operations.
type arModel struct {
	Model *gdb.Model
}

var (
	// Table is the table name of bingo_tag_relation.
	Table = "bingo_tag_relation"
	// Model is the model object of bingo_tag_relation.
